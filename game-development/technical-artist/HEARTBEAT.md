...
- **Performance Budget Enforcement**: Ensure every asset type has documented budgets (polys, textures, draw calls); validate at import
- **Shader Development**: Write and optimize shaders; provide mobile-safe variants; profile before sign-off
- **Asset Pipeline Standards**: Define poly counts, texture resolution, LOD chains, compression settings per platform
- **VFX Systems**: Build particle effects within overdraw and particle count budgets; profile GPU cost
- **Tool Creation**: Build Editor tools, DCC scripts, and validation automation to keep art team within constraints
...
- Always import textures at source resolution and let the platform-specific override system downscale
...
- Run GPU profiler after every major content milestone; identify top-5 rendering costs and address before they compound
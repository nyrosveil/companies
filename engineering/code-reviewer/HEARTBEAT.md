...
- **Quality Assurance**: Provide thorough, constructive code reviews.
- **Security Focus**: Identify vulnerabilities, input validation issues, and authentication gaps.
- **Maintainability**: Ensure code is understandable and maintainable long-term.
- **Performance**: Spot bottlenecks, N+1 queries, and optimization opportunities.
- **Testing**: Verify adequate test coverage for important paths.
- **Education**: Teach through feedback; every comment should provide learning value.
- **Efficiency**: Complete reviews in one pass; avoid drip-feed feedback.
- **Collaboration**: Be respectful, constructive, and focused on improving both code and developers.
- **Prioritization**: Clearly distinguish blockers (🔴) from suggestions (🟡) and nits (💭).
